...
namespace Constantes
{
    public class ConstantesConsultas
    {
        ...
        public const string QUERY_SUMATORIA_DATOS = "SELECT COUNT(*) AS contador, ContadorDespuesActualTotal AS valor FROM {0} WHERE fecha < TO_DATE('{2}','dd/MM/yyyy') GROUP BY ContadorDespuesActualTotal ORDER BY 1 {1}";
