...
namespace Presenter
{
    public class AnalisisPosUno
    {
        ...
        public static Dictionary<int, ObjectInfoDTO> ValidarIndicadoresPosicion(AstEntities _astEntities, Dictionary<int, ObjectInfoDTO> dict, InfoPosicionDTO infoPosicion, string fechaFormat, int dia)
        {
            ...
            //bool fechaNoComparaContDiaSemana = AnalisisPosicionGeneral.ObtenerBanderaIndicador(_astEntities, ConstantesGenerales.AN_DAT_POS_UNO, ConstantesGenerales.COMPARA_CONT_DIA_SEM, 0, fechaFormat, dia);
            //bool fechaNoIndicaMinDiaMes = AnalisisPosicionGeneral.ObtenerBanderaIndicador(_astEntities, ConstantesGenerales.AN_DAT_POS_UNO, ConstantesGenerales.INDICA_MIN_CONT_DIA_MES, 1, fechaFormat, dia);
            bool fechaNoComparaContDiaMes = AnalisisPosicionGeneral.ObtenerBanderaIndicador(_astEntities, ConstantesGenerales.AN_DAT_POS_UNO, ConstantesGenerales.COMPARA_CONT_DIA_MES, 0, fechaFormat, dia);
            bool fechaNoIndicaMinDiaMod = AnalisisPosicionGeneral.ObtenerBanderaIndicador(_astEntities, ConstantesGenerales.AN_DAT_POS_UNO, ConstantesGenerales.INDICA_MIN_CONT_DIA_MOD, 1, fechaFormat, dia);
            //bool fechaNoComparaContDiaMod = AnalisisPosicionGeneral.ObtenerBanderaIndicador(_astEntities, ConstantesGenerales.AN_DAT_POS_UNO, ConstantesGenerales.COMPARA_CONT_DIA_MOD, 0, fechaFormat, dia);
            //bool fechaNoIndicaMinMes = AnalisisPosicionGeneral.ObtenerBanderaIndicador(_astEntities, ConstantesGenerales.AN_DAT_POS_UNO, ConstantesGenerales.INDICA_MIN_CONT_MES, 1, fechaFormat, dia);
            bool fechaNoComparaContMes = AnalisisPosicionGeneral.ObtenerBanderaIndicador(_astEntities, ConstantesGenerales.AN_DAT_POS_UNO, ConstantesGenerales.COMPARA_CONT_MES, 0, fechaFormat, dia);
            //bool fechaNoIndicaMinDespActual = AnalisisPosicionGeneral.ObtenerBanderaIndicador(_astEntities, ConstantesGenerales.AN_DAT_POS_UNO, ConstantesGenerales.INDICA_MIN_CONT_DESP_ACTUAL, 1, fechaFormat, dia);
            bool fechaNoComparaContDespActual = AnalisisPosicionGeneral.ObtenerBanderaIndicador(_astEntities, ConstantesGenerales.AN_DAT_POS_UNO, ConstantesGenerales.COMPARA_CONT_DESP_ACTUAL, 0, fechaFormat, dia);
            bool fechaNoMinPuntuaTotal = AnalisisPosicionGeneral.ObtenerBanderaIndicador(_astEntities, ConstantesGenerales.AN_DAT_POS_UNO, ConstantesGenerales.INDICA_MIN_PUNTUA_TOTAL, 1, fechaFormat, dia);
            //bool fechaNoMaxPuntuaTotal = AnalisisPosicionGeneral.ObtenerBanderaIndicador(_astEntities, ConstantesGenerales.AN_DAT_POS_UNO, ConstantesGenerales.INDICA_MAX_PUNTUA_TOTAL, 1, fechaFormat, dia);
            //bool fechaNoMinSumatoria = AnalisisPosicionGeneral.ObtenerBanderaIndicador(_astEntities, ConstantesGenerales.AN_DAT_POS_UNO, ConstantesGenerales.INDICA_MIN_SUMATORIA, 1, fechaFormat, dia);
            bool fechaNoMaxSumatoria = AnalisisPosicionGeneral.ObtenerBanderaIndicador(_astEntities, ConstantesGenerales.AN_DAT_POS_UNO, ConstantesGenerales.INDICA_MAX_SUMATORIA, 1, fechaFormat, dia);
        ...
        public static Dictionary<int, ObjectInfoDTO> ValidarAbsolutoSinAparecer(Dictionary<int, ObjectInfoDTO> dict)
        {
            ...
            foreach (var item in dict)
            {
                ...
                bool eliminar = valorAbs == item.Value.RankContadorDiaSemana;
                if (eliminar)
                {
