...
namespace Presenter
{
    public class AnalisisPosCuatro
    {
        /// <summary>
        ...
        {
            bool fechaNoSinAparecer = AnalisisPosicionGeneral.ObtenerBanderaIndicador(_astEntities, ConstantesGenerales.AN_DAT_POS_CUATRO, ConstantesGenerales.INDICA_MIN_SIN_APARECER, 1, fechaFormat, dia);
            bool fechaNoUltRach = AnalisisPosicionGeneral.ObtenerBanderaIndicador(_astEntities, ConstantesGenerales.AN_DAT_POS_CUATRO, ConstantesGenerales.INDICA_MIN_ULT_RACH, 1, fechaFormat, dia);
            ...
            bool fechaNoComparaUltRachas = AnalisisPosicionGeneral.ObtenerBanderaIndicador(_astEntities, ConstantesGenerales.AN_DAT_POS_CUATRO, ConstantesGenerales.COMPARA_ULT_RACH, 0, fechaFormat, dia);
            ...
            bool fechaNoMinContGeneral = AnalisisPosicionGeneral.ObtenerBanderaIndicador(_astEntities, ConstantesGenerales.AN_DAT_POS_CUATRO, ConstantesGenerales.INDICA_MIN_CONT_GENERAL, 1, fechaFormat, dia);
            //bool fechaNoComparaContGeneral = AnalisisPosicionGeneral.ObtenerBanderaIndicador(_astEntities, ConstantesGenerales.AN_DAT_POS_CUATRO, ConstantesGenerales.COMPARA_CONT_GENERAL, 0, fechaFormat, dia);
            bool fechaNoMinContDiaSemana = AnalisisPosicionGeneral.ObtenerBanderaIndicador(_astEntities, ConstantesGenerales.AN_DAT_POS_CUATRO, ConstantesGenerales.INDICA_MIN_CONT_DIA_SEM, 1, fechaFormat, dia);
            //bool fechaNoComparaContDiaSemana = AnalisisPosicionGeneral.ObtenerBanderaIndicador(_astEntities, ConstantesGenerales.AN_DAT_POS_CUATRO, ConstantesGenerales.COMPARA_CONT_DIA_SEM, 0, fechaFormat, dia);
            //bool fechaNoIndicaMinDiaMes = AnalisisPosicionGeneral.ObtenerBanderaIndicador(_astEntities, ConstantesGenerales.AN_DAT_POS_CUATRO, ConstantesGenerales.INDICA_MIN_CONT_DIA_MES, 1, fechaFormat, dia);
            //bool fechaNoComparaContDiaMes = AnalisisPosicionGeneral.ObtenerBanderaIndicador(_astEntities, ConstantesGenerales.AN_DAT_POS_CUATRO, ConstantesGenerales.COMPARA_CONT_DIA_MES, 0, fechaFormat, dia);
            bool fechaNoIndicaMinDiaMod = AnalisisPosicionGeneral.ObtenerBanderaIndicador(_astEntities, ConstantesGenerales.AN_DAT_POS_CUATRO, ConstantesGenerales.INDICA_MIN_CONT_DIA_MOD, 1, fechaFormat, dia);
            //bool fechaNoComparaContDiaMod = AnalisisPosicionGeneral.ObtenerBanderaIndicador(_astEntities, ConstantesGenerales.AN_DAT_POS_CUATRO, ConstantesGenerales.COMPARA_CONT_DIA_MOD, 0, fechaFormat, dia);
            bool fechaNoIndicaMinMes = AnalisisPosicionGeneral.ObtenerBanderaIndicador(_astEntities, ConstantesGenerales.AN_DAT_POS_CUATRO, ConstantesGenerales.INDICA_MIN_CONT_MES, 1, fechaFormat, dia);
            //bool fechaNoComparaContMes = AnalisisPosicionGeneral.ObtenerBanderaIndicador(_astEntities, ConstantesGenerales.AN_DAT_POS_CUATRO, ConstantesGenerales.COMPARA_CONT_MES, 0, fechaFormat, dia);
            bool fechaNoIndicaMinDespActual = AnalisisPosicionGeneral.ObtenerBanderaIndicador(_astEntities, ConstantesGenerales.AN_DAT_POS_CUATRO, ConstantesGenerales.INDICA_MIN_CONT_DESP_ACTUAL, 1, fechaFormat, dia);
            //bool fechaNoComparaContDespActual = AnalisisPosicionGeneral.ObtenerBanderaIndicador(_astEntities, ConstantesGenerales.AN_DAT_POS_CUATRO, ConstantesGenerales.COMPARA_CONT_DESP_ACTUAL, 0, fechaFormat, dia);
            bool fechaNoMinPuntuaTotal = AnalisisPosicionGeneral.ObtenerBanderaIndicador(_astEntities, ConstantesGenerales.AN_DAT_POS_CUATRO, ConstantesGenerales.INDICA_MIN_PUNTUA_TOTAL, 1, fechaFormat, dia);
            //bool fechaNoMaxPuntuaTotal = AnalisisPosicionGeneral.ObtenerBanderaIndicador(_astEntities, ConstantesGenerales.AN_DAT_POS_CUATRO, ConstantesGenerales.INDICA_MAX_PUNTUA_TOTAL, 1, fechaFormat, dia);
            bool fechaNoMinSumatoria = AnalisisPosicionGeneral.ObtenerBanderaIndicador(_astEntities, ConstantesGenerales.AN_DAT_POS_CUATRO, ConstantesGenerales.INDICA_MIN_SUMATORIA, 1, fechaFormat, dia);
            //bool fechaNoMaxSumatoria = AnalisisPosicionGeneral.ObtenerBanderaIndicador(_astEntities, ConstantesGenerales.AN_DAT_POS_CUATRO, ConstantesGenerales.INDICA_MAX_SUMATORIA, 1, fechaFormat, dia);
