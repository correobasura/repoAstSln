...
create table AN_DAT_POS_UNO(
	...
	INDICA_MAX_ULT_RACH NUMBER,
	INDICA_MAX_CONT_ULT_RACH_DES_A NUMBER,
...
var_max_dato_cont_ult_rach NUMBER;
var_ind_max_cont_ult_rach NUMBER;
var_max_dat_con_ult_rach_desac NUMBER;
var_in_mx_dat_con_ul_rac_desac NUMBER;
...
begin
    ...
    END IF;
    IF :new.contadorultimoenrachas = var_max_dato_cont_ult_rach 
    	THEN var_ind_max_cont_ult_rach := 1;
    ELSE var_ind_max_cont_ult_rach := 0;
    END IF;
    IF :new.contadorultimoenrachasdesactua = var_max_dat_con_ult_rach_desac 
	...
	INSERT INTO AN_DAT_POS_UNO(ID, INDICA_MIN_SIN_APARECER, INDICA_MIN_ULT_RACH, COMPARA_ULT_RACH, 
		INDICA_MAX_ULT_RACH, INDICA_MAX_CONT_ULT_RACH_DES_A, INDICA_MIN_CONT_GENERAL, COMPARA_CONT_GENERAL, 
