...
CREATE TABLE POS_UNO_DATOS(
	...
	ContadorMes NUMBER,
	ContadorDiaAnio NUMBER,
	ContadorDiaAnioModulo NUMBER,
	ContadorMesModuloDiaModulo NUMBER,
	ContadorMesDia NUMBER,
	ContadorAnioModulo NUMBER,
	ContadorMesModulo NUMBER,
	ContadorDespuesActual NUMBER,
	ContadorDespuesOtroTipo NUMBER,
...
begin
	...
	AND posicion = 1;
	SELECT contadorultimoenrachas, contadorgeneral, contadordiasemana, contadordiames, contadordiamodulo, contadormes, ContadorDespuesActual
	INTO var_anterior_cont_ult_rach, var_anterior_cont_general, var_anterior_cont_dia_semana, var_anterior_cont_dia_mes, var_anterior_cont_dia_modulo, var_anterior_cont_mes, var_anterior_cont_desp_actual
	FROM POS_UNO_DATOS 
